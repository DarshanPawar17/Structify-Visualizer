        ...
        <div className='bg-surface min-h-screen text-on-surface font-sans'>
            ...
            <section className="pt-24 pb-12 px-8 text-center">
                ...
                <p className="text-[#717171] text-[1rem] italic max-w-2xl mx-auto" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                    A complete binary hierarchy where every zenith dominates its descendants in magnitude.
                </p>
            </section>
                            ...
                            <div className="flex flex-col gap-10">
                                ...
                                <div className="flex flex-col gap-8">
                                    ...
                                    <div className="flex flex-col gap-3 pt-4">
                                        ...
                                        <button onClick={() => handleAction('delete')} className="border border-primary text-primary text-[0.65rem] font-bold tracking-[0.2em] uppercase py-4 hover:bg-surface-container-low transition-colors rounded-sm">Extract Max</button>
                                        <p className="text-[0.7rem] text-[#717171] mt-2 italic font-serif">Add a value and bubble it up to maintain the Max-priority property.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col gap-8">
                                    <div className="bg-[#F7F9F9] p-6 border-l-2 border-primary">
                                        <p className="text-[0.75rem] text-[#717171] leading-relaxed italic font-serif">
                                            "I am specialized in Max Heap architecture. Ask regarding heapify logic or priority queue applications."
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="e.g., Explain the time complexity of building a heap."
                                            rows={4}
                                        ></textarea>
                                    </div>

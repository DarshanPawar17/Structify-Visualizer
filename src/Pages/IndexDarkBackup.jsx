        ...
        <div className='flex w-full justify-center gap-3 mt-8 flex-col sm:flex-row items-center'>
          ...
          <HashLink smooth to="/#DataStructure">
            <button 
              ...
              className="bg-[#00D4FF] rounded-lg px-6 py-3 font-semibold cursor-pointer flex items-center gap-3 text-black transition-all duration-300 group hover:scale-105 premium-hover w-full sm:w-auto"
            >
              {/* Play Icon */}
          ...
          <Link to="/documentation">
            <button 
              onClick={() => playSound('click')}
              onMouseEnter={() => playSound('hover')}
              className="border border-gray-400 px-6 py-2 rounded-lg text-gray-200 text-lg flex items-center gap-2 hover:bg-[#3ED0FF] hover:text-black transition-all hover:border-blue-500 cursor-pointer font-semibold hover:scale-105 premium-hover w-full sm:w-auto"
            >

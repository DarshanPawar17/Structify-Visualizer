...
import { handleInsert, handleDelete, handleSearch, renderTree, avlTree, handleTraversal } from '../utils/AvlTree';
...
function AvlTreeVisualizer() {
    ...
    const handleAction = async (actionType) => {
        ...
        switch (actionType) {
            ...
            case 'postorder':
            case 'levelorder':
                const seq = await handleTraversal(avlTreeVisAreaRef.current, actionType, setHistoryList, hisNum, displayMessage);
        ...
        <div className='bg-surface min-h-screen text-on-surface font-sans'>
            ...
            <section className="pt-24 pb-12 px-8 text-center">
                ...
                <p className="text-[#717171] text-[1rem] italic max-w-2xl mx-auto" style={{ fontFamily: '"Cormorant Garamond", serif' }}>
                    A self-balancing search hierarchy maintaining rigorous height symmetry for optimal performance.
                </p>
            </section>
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                                        ...
                                        <div className="flex flex-col gap-3 pt-4">
                                            {selectedOperation === 'treeOp' ? (
                                                <>
                                                    ...
                                                    <p className="text-[0.7rem] text-[#717171] mt-2 italic font-serif">Integrate or prune nodes; automatic rotations will trigger if height symmetry deviates.</p>
                                                </>
                                            ) : (
                                                <>
                        ...
                        <div className="lg:col-span-8 bg-white min-h-[650px] border border-[#EBEBEB] p-12 relative flex flex-col">
                            ...
                            <div className="flex-1 flex flex-col justify-center items-center overflow-hidden">
                                <div ref={avlTreeVisAreaRef} id="AVL-tree-container" className="relative w-full h-[550px] flex justify-center items-start pt-[50px]">
                                    <div className="text-center opacity-30 select-none flex flex-col gap-4 mt-20">
                                        <span className="text-[0.7rem] font-bold tracking-[0.2em] uppercase text-[#B0B0B0]">Empty Balance</span>
                                ...
                                <div className="flex-1 flex flex-col gap-8">
                                    <div className="bg-[#F7F9F9] p-6 border-l-2 border-primary">
                                        <p className="text-[0.75rem] text-[#717171] leading-relaxed italic font-serif">
                                            "I am specialized in AVL architecture. Ask regarding rotation mechanics or height-balance maintenance."
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="e.g., Explain the difference between LL and LR rotations."
                                            rows={4}
                                        ></textarea>
                                    </div>
